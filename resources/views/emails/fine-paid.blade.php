...
<div style="max-width:600px; margin:auto; background:white; border-radius:10px; overflow:hidden;">
    ...
    <div style="padding:30px;">
        ...
        <p>We've received your fine payment. Thanks for clearing it up!</p>

        <div style="background:#f8f9fa; padding:15px; border-radius:8px; margin:20px 0;">
            <strong>Book Title:</strong> {{ $fine->rental->book->title }}<br><br>
            <strong>Amount Paid:</strong> ₹{{ $fine->fine_amount }}<br><br>
            <strong>Late Days:</strong> {{ $fine->late_days }} days<br><br>
            <strong>Status:</strong> Paid
        </div>

        <p>You're all clear — you can continue renting books from BookNest.</p>
